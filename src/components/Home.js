    ...
    render() {
        ...
        if (this.props.checked) {
            ...
            return (<CardDeck className='horizontal-carddeck' >
                ...
                <Modal show={this.state.show} onHide={this.handleClose} >
                    <Modal.Header closeButton>
                        <Modal.Title bsPrefix='header-modal'>{this.state.obj.title}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <h4 className='share-title-modal'>Share via</h4>
                        <div className='share-icon-modal'>
                            <FacebookShareButton url={this.state.obj.url} hashtag='#CS_571_NewsApp'>
                                <FacebookIcon size={64} round />
                            </FacebookShareButton>
                            <TwitterShareButton url={this.state.obj.url} hashtags={['CSCI_571_NewsApp']}>
                                <TwitterIcon size={64} round />
                            </TwitterShareButton>
                            <EmailShareButton url={this.state.obj.url} subject='#CS_571_NewsApp'>
                                <EmailIcon size={64} round />
                            </EmailShareButton>
                        </div>
                    </Modal.Body>
